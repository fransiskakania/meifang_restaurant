            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="form-group">
                        <label for="edit_total_payment">Total Pembayaran</label>
                        <input type="text" class="form-control" name="total_payment" id="edit_total_payment" required>
                    </div>
                    <div class="form-group">
...
$(document).ready(function() {
    ...
    $(".edit-btn").click(function() {
        ...
        $.ajax({
            url: "get_transaction.php", // File PHP untuk mengambil data
            type: "GET",
    ...
    // Ketika form submit untuk update
    $("#editForm").submit(function(e) {
        e.preventDefault();

        $.ajax({
            url: "update_transaction.php", // File PHP untuk update data
            type: "POST",
