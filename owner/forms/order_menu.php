...
<html lang="en">
  <head>
    ...
    <title>Meifang Resto - Aplikasi Kasir</title>
    <meta
...
<script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script>
  ...
  <body>
                ...
                <form action="add_menu.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="price" name="price" placeholder="Add Harga" step="0.01" required>
                        </div>
                        <div class="form-group">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="menu-selection">
            <ul class="nav nav-pills nav-primary">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="filterSelection('filter-main-course')">MAIN COURSE</a>
                </li>
                <li class="nav-item">
    ...
    <div class="row no-gutters">
      <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-main-course">
      <div class="card h-90 text-center border-light position-relative" 
          data-id-masakan="196" data-stock-menu="10">
          <img src="../assets/img/maincourse/one.png" alt="menuimage" class="card-img-top menu-image">
          <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
              <div>
                  <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">Golden Fuyung</h4>
                  <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 35.500</p>
              </div>
          </div>
        ...
        <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-main-course">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="200" data-stock-menu="10">
                <img src="../assets/img/maincourse/mie.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">Mie Shoa</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 27.800</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-main-course">
         <div class="card h-90 text-center border-light position-relative" data-id-masakan="204" data-stock-menu="10">
                <img src="../assets/img/maincourse/duck.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">Peking Duck</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 50.200</p>
                </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-main-course">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="205" data-stock-menu="10">
                <img src="../assets/img/maincourse/rice.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">Chow Fried Rice</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 30.300</p>
                </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-main-course">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="206" data-stock-menu="10">
                <img src="../assets/img/maincourse/tomyum.png" alt="menuimage" class="card-img-top menu-image">
                 <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                 <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">Tom Yum</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 57.900</p>
                </div>
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-main-course">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="231" data-stock-menu="10">
            <img src="../assets/img/maincourse/chicken.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
            <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Chicken Charsiu</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 85.800 </p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-drink">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="186" data-stock-menu="10">
                <img src="../assets/img/drinks/teh.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Teh Bunga Krisan</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 15.200</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-drink">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="187" data-stock-menu="10">
            <img src="../assets/img/drinks/5.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
            <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Dragon Ice</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 17.200</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-drink">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="208" data-stock-menu="10">
            <img src="../assets/img/drinks/bubble.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
            <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Bubble Milk Tea</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 18.400</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-drink">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="209" data-stock-menu="10">
            <img src="../assets/img/drinks/orange.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
            <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Orange Ice</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 17.700</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-drink">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="210" data-stock-menu="8" >
            <img src="../assets/img/drinks/latte.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
            <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Cappucino Latte</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 21.800</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-drink">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="211" data-stock-menu="10">
            <img src="../assets/img/drinks/7.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Sparkling Water</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 12.500</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-snack">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="188"data-stock-menu="10">
                <img src="../assets/img/snack/satu.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Dimsum Delight</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 24.500</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-snack">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="189"data-stock-menu="10">
            <img src="../assets/img/snack/dua.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
            <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Gyoza Dynasty</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 36.800</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-snack">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="212"data-stock-menu="10">
            <img src="../assets/img/snack/tiga.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
            <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Zongzi Bakcang</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 20.500</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-snack">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="216"data-stock-menu="10">
            <img src="../assets/img/snack/empat.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
            <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Bakpao Quang</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 19.400</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-snack">
            <div class="card h-90 text-center border-light position-relative"data-id-masakan="220"data-stock-menu="10">
            <img src="../assets/img/snack/lima.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
            <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    Spring Rolls</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 15.800</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-snack">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="214"data-stock-menu="10">
            <img src="../assets/img/snack/8.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                <div>
                    <h4 style="font-size: 16px; margin-top: -15px; margin-bottom: 2px;">
                    French Fries</h4>
                    <p style="font-size: 14px; margin: -2px 0 2px 0;">Rp 12.400</p>
                            </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-dessert">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="190"data-stock-menu="10">
                <img src="../assets/img/dessert/eins.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                      <div>
                    <h4 style="font-size: 16px; margin-bottom: 1px;">Strawberry Cupcake</h4>
                    <p style="font-size: 14px; margin-top: 0;">Rp 17.300</p>
                </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-dessert">
            <div class="card h-90 text-center border-light position-relative"  data-id-masakan="191"data-stock-menu="10">
            <img src="../assets/img/dessert/zwei.png" alt="menuimage" class="card-img-top menu-image">
            <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                      <div>
                    <h4 style="font-size: 16px; margin-bottom: 1px;">Mango Pudding</h4>
                    <p style="font-size: 14px; margin-top: 0;">Rp 25.300</p>
                </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-dessert">
            <div class="card h-90 text-center border-light position-relative"  data-id-masakan="217"data-stock-menu="10">
                <img src="../assets/img/dessert/drei.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                      <div>
                    <h4 style="font-size: 16px; margin-bottom: 1px;"> Vannilla Ice Cream</h4>
                    <p style="font-size: 14px; margin-top: 0;"> Rp 18.000</p>
                </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-dessert">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="218"data-stock-menu="10">
                <img src="../assets/img/dessert/vier.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                      <div>
                    <h4 style="font-size: 16px; margin-bottom: 1px;">Donut Doms</h4>
                    <p style="font-size: 14px; margin-top: 0;">Rp 20.200 </p>
                </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
         ...
         <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-2 portfolio-item filter-dessert">
            <div class="card h-90 text-center border-light position-relative" data-id-masakan="219"data-stock-menu="10">
                <img src="../assets/img/dessert/funf.png" alt="menuimage" class="card-img-top menu-image">
                <div class="c-body position-absolute w-100 h-100 d-flex align-items-center justify-content-center text-white portfolio-info">
                      <div>
                    <h4 style="font-size: 16px; margin-bottom: 1px;">Cheese Cake</h4>
                    <p style="font-size: 14px; margin-top: 0;">Rp 21.200 </p>
                </div>
                </div>
                <!-- Quantity control icons -->
              <div class="quantity-control position-absolute d-flex align-items-center justify-content-center" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
