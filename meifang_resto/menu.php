...
<head>
    ...
    font-family: 'Poppins', sans-serif;
     ...
     #ftco-navbar {
        background-color:rgb(168, 12, 12); /* Ganti dengan kode warna yang Anda inginkan */
...
.navbar.hide {
  top: -80px; /* Sesuaikan tinggi navbar jika diperlukan */
}
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar sticky-top" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.php">MEIFANG RESTO<span></span></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="index#menu" class="nav-link">Menu</a></li>
                <li class="nav-item"><a href="index#about" class="nav-link">About</a></li>
                <li class="nav-item active"><a href="menu.php" class="nav-link">Favourite</a></li>
                <li class="nav-item"><a href="reservation.html" class="nav-link">Cart</a></li>
            </ul>
        </div>
    </div>
</nav>
