...
<body>
    ...
    <div class="container">
        <div class="card p-4">
            <h2 class="text-center mb-4">Payment Guide (Virtual Account Method)</h2>
            <ol class="list-group list-group-numbered">
                <li class="list-group-item">Transfer the total amount to the generated virtual account number</li>
                <li class="list-group-item">After the payment has been made, the system will automatically verify the transaction. </li>
